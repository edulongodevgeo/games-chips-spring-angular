...
public class GamesandchipsApplication implements CommandLineRunner{
	...
	public static void main(String[] args) {
		SpringApplication.run(GamesandchipsApplication.class, args);
	}

	
	//Rodar sempre que startar a aplicação
	@Override
